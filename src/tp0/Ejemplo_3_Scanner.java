...
public class Ejemplo_3_Scanner {
    ...
    static final String NOMBRE_ARCHIVO = "src/tp0_txt/numeros.txt";

    // Se crea flujo de lectura del archivo creado en el ejemplo 2 y se lo abre con un buffer. Se imprime los primeros 10 numeros que contiene el archivo.
    ...
    // Se crea flujo de lectura en archivo ejemplo_scanner. Se abre flujo con buffer y se crea lector asociado a ese buffer. Se imprime por pantalla el contenido identificando cada linea.
    private static void leerArchivo_2(){
    	try{
    		BufferedReader buff = new BufferedReader(new FileReader("src/tp0_txt/ejemplo_scanner"));
    		Scanner s = new Scanner(buff);
